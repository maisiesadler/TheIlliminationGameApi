...
// UpdateRequest is the request for this handler
...
func Handler(request events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	...
	if err != nil {
		...
		return events.APIGatewayProxyResponse{StatusCode: 400}, errParse
	}
	...
	err = userOption.UpdateUserOption(user, r.Updates)
	if err != nil {
		fmt.Printf("Error updating user option: '%v'.\n", err)
		return apigateway.ResponseUnsuccessful(500), err
	}
